<?php
    ...
    $sql = "SELECT id, name, email, password, role, avatar, sex, status FROM users WHERE 1";
                    ...
                    <div class="panel-content">
                        ...
                        <div class="frame-wrap">
                            <div class="form-group">
                                ...
                                <a href="fill_with_test_data.php" class="btn btn-primary" data-toggle="tooltip" data-original-title="Заполняет тестовыми данными из файла config\test_data.php, роль - случайная, пароль - 12345, пол - муж, статус - активен">Заполнить тестовыми данными</a>
                            </div>
                            <table class="table m-0">
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="show.php?id=<?=$user['id'] ?>" class="btn btn-info fa fa-eye" data-toggle="tooltip" data-original-title="Посмотреть"></a>
